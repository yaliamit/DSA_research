...
python3 train_faster_rcnn_occ.py --config_file=args_frcnn.conf --run_gpu=1 --cnn_num_train=4000 --cnn_num_valid=1000 --train_data_suffix=_aoc --n_epochs=3 > out_frcnn.txt
